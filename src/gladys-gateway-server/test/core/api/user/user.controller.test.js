...
describe('POST /users/signup', () => {
  it('should signup one user', () => request(TEST_BACKEND_APP)
    .post('/users/signup')
    .send({
      name: 'Tony',
  ...
  it('should not signup user, missing attributes', () => request(TEST_BACKEND_APP)
    .post('/users/signup')
    .send({
      email: 'tony.stark@gladysassistant.com',
      language: 'en',
...
describe('POST /users/login-salt', () => {
  it('should return a salt', () => request(TEST_BACKEND_APP)
  ...
  it('should return 404 not found', () => request(TEST_BACKEND_APP)
    .post('/users/login-salt')
    .send({
...
describe('POST /users/login-finalize', () => {
  it('should return a server_session_proof and access_token', () => request(TEST_BACKEND_APP)
  ...
  it('should return 403 forbidden. Wrong client proof', () => request(TEST_BACKEND_APP)
    .post('/users/login-finalize')
    .send({
      login_session_key: '2b2aa099-4323-44e8-bb07-0b9b55dbe1dc',
...
describe('POST /users/two-factor-configure', () => {
  it('should configure two factor and return otpauth_url', () => request(TEST_BACKEND_APP)
  ...
  it('should return 401 unauthorized, no jwt provided', () => request(TEST_BACKEND_APP)
    .post('/users/two-factor-configure')
    .set('Accept', 'application/json')
    .expect('Content-Type', /json/)
    .expect(401)
...
describe('PATCH /users/me', () => {
  it('should update user account', () => request(TEST_BACKEND_APP)
    .patch('/users/me')
    .set('Accept', 'application/json')
  ...
  it('should update user email and send email', () => request(TEST_BACKEND_APP)
    .patch('/users/me')
    .set('Accept', 'application/json')
    .set('Authorization', configTest.jwtAccessTokenDashboard)
    .send({
...
describe('GET /users/me', () => {
  it('should get user account', () => request(TEST_BACKEND_APP)
    .get('/users/me')
    .set('Accept', 'application/json')
    .set('Authorization', configTest.jwtAccessTokenDashboard)
    .expect('Content-Type', /json/)
...
describe('POST /users/forgot-password', () => {
  it('should return success', () => request(TEST_BACKEND_APP)
  ...
  it('should return 404', () => request(TEST_BACKEND_APP)
    .post('/users/forgot-password')
    .set('Accept', 'application/json')
    .send({
...
describe('POST /users/reset-password', () => {
  ...
  it('should return 422, missing srp_salt', () => request(TEST_BACKEND_APP)
    .post('/users/reset-password')
    .set('Accept', 'application/json')
    .send({
      token: 'd295b5bcc79c7951a95c24a719a778b6dc18334a9fe175a2807513d6e4d1b9a849fad6fab13adc00cf094636c5ad62263a0469d19447a42a82bd729f8c8e7b07',
...
describe('GET /users/reset-password/:token', () => {
  ...
  it('should return email of the user', () => request(TEST_BACKEND_APP)
...
describe('GET /users/setup', () => {
  it('should get setup state', () => request(TEST_BACKEND_APP)
    .get('/users/setup')
    .set('Accept', 'application/json')
    .set('Authorization', configTest.jwtAccessTokenDashboard)
    .expect('Content-Type', /json/)
...
describe('GET /users/two-factor/new', () => {
  it('should generate new two factor secret', () => request(TEST_BACKEND_APP)
